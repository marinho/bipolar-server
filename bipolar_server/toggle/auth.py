...
def signup_email(request):
    return render_to_response('auth/email_signup.html', {}, RequestContext(request))


def validation_sent(request):
    return render_to_response('auth/validation_sent.html', {
...
def require_email(request):
    ...
    return render_to_response('auth/email.html', RequestContext(request))
