...
urlpatterns = patterns('bipolar_server.toggle.views',
    ...
    url(r'^accounts/(?P<shortcode>[A-Z0-9]{8})/delete/$', "account_delete", name="account_delete"),
    ...
    url(r'^search-users.json$', "search_users", name="search_users"),
    url(r'^accounts/(?P<shortcode>[A-Z0-9]{8})/users/(?P<user_pk>\d+)/$', "user_add", name="user_add"),
    url(r'^accounts/(?P<shortcode>[A-Z0-9]{8})/users/(?P<user_pk>\d+)/delete/$', "user_delete", name="user_delete"),
    )
